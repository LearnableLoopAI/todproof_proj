...
class Translation(models.Model):
  ...
  message = models.ForeignKey(Message, blank=True, null=True, on_delete=models.CASCADE, related_name='translations')
...
class Assignment(models.Model):
  ...
  class Status(models.TextChoices):
    ...
    pr = 'pr', _('Pruned (pr)')
  translation = models.ForeignKey(Translation, blank=False, null=False, on_delete=models.DO_NOTHING, related_name='assignments')
  # user = models.ForeignKey(User, blank=False, null=False, on_delete=models.DO_NOTHING, related_name='tasks') #for members app
  user = models.ForeignKey(settings.AUTH_USER_MODEL, blank=False, null=False, on_delete=models.DO_NOTHING, related_name='assignments') #for accounts app
  ...
  def __str__(self):
    return f"[{self.translation.lan} {self.translation.blkc}.{self.translation.subc}.{self.translation.senc}.{self.translation.xcrip}] {self.translation.message.descriptor} {self.translation.message.title} ({self.translation.version}) ({self.role}) {self.user.username} {self.place}"
...
class Edit(models.Model):
  class TopEditType(models.TextChoices):
    N = 'N', _('Not top edit')
    Z = 'Z', _('Zero vote top edit')
    T = 'T', _('Tie top edit')
    M = 'M', _('Majority top edit')
...
class Contribution(models.Model):
  ...
  base_edit = models.ForeignKey(Edit, blank=True, null=True, on_delete=models.CASCADE)
  ...
  assignment = models.ForeignKey(Assignment, blank=False, null=False, on_delete=models.CASCADE, related_name='contributions')
  edit = models.ForeignKey(Edit, blank=False, null=False, on_delete=models.CASCADE, related_name='contributions')
  created_at = models.DateTimeField(auto_now_add=True)
  updated_at = models.DateTimeField(auto_now=True)
